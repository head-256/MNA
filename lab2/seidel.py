...
if __name__ == "__main__":
    ...
    print("Result: {roots}".format(roots=seidel(A, B, 0.001)))
    print("Result: {roots}".format(roots=seidel(A2, B2, 0.001)))
    print("Result: {roots}".format(roots=seidel(A3, B3, 0.001)))
    print("Result: {roots}".format(roots=seidel(A4, B4, 0.001)))
